...
removeEntities = function(str) {
    str = str.replaceAll(str, '%26', 'and');
    str = str.replaceAll(str, '%27', '');
    str = str.replaceAll(str, '%28', '');
    str = str.replaceAll(str, '%29', '');
    str = str.replaceAll(str, '%21', '');
    str = str.replaceAll(str, '.', '');
    str = str.replaceAll(str, '%3A', '');
    str = str.replaceAll(str, '%C2', '');
    str = str.replaceAll(str, '%B0', '');
    str = str.replaceAll(str, '%2C', '');
    str = str.replaceAll(str, '%3F', '');
    str = str.replaceAll(str, '%E2', '');
    str = str.replaceAll(str, '%80', '');
    str = str.replaceAll(str, '%99', '');
    str = str.replaceAll(str, '%2F', '');
    str = str.replaceAll(str, '%21', '');
